...
import 'package:journz_web/Tab/tab_home_page_center_pane_article_card.dart';
import 'package:journz_web/utils/routes.dart';
import 'package:velocity_x/velocity_x.dart';

import '../MiniDesktop/mini_desktop_home_page_center_pane_article_card.dart';
import 'mobile_home_page_center_pane_article_card.dart';


class MobileBodyCenterPaneArticleSection extends StatefulWidget {
  const MobileBodyCenterPaneArticleSection({Key? key}) : super(key: key);
...
class _BodyCenterPaneArticleSectionState
    extends State<MobileBodyCenterPaneArticleSection> {
                              ...
                              itemBuilder: (context, index) {
                                return InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    child: MobileHomePageCenterPaneArticleCard(
                                        index: index,
