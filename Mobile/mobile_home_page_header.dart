...
import 'package:journz_web/Common/Data/country.dart';
import 'package:journz_web/Common/Data/user_terms_condition.dart';
import 'package:journz_web/Common/Helper/dialogs.dart';
import 'package:journz_web/HiveArticlesModel/ArticleModel/hive_article_data.dart';
import 'package:journz_web/NewHomePage/Cubits/AgreeTermsAndConditionscubit/agree_terms_conditions_cubit.dart';
import 'package:journz_web/NewHomePage/Cubits/CheckUserLoginedCubit/checkuserlogined_cubit.dart';
import 'package:journz_web/NewHomePage/Cubits/GoToMpinCubit/go_to_mpin_cubit.dart';
import 'package:journz_web/NewHomePage/Cubits/PassCountrySearchTextCubit/pass_country_search_text_cubit.dart';
import 'package:journz_web/NewHomePage/Cubits/PassVerificationIdCubit/pass_verification_id_cubit.dart';
import 'package:journz_web/NewHomePage/Cubits/SelectCountryAtSignupCubit/select_country_at_signup_cubit.dart';
import 'package:journz_web/NewHomePage/Cubits/ShowCountryCodeAtSignUpUiCubit/show_country_code_at_signup_ui_cubit.dart';
import 'package:journz_web/NewHomePage/Cubits/ShowHideLoginPasswordCubit/show_hide_login_password_cubit.dart';
import 'package:journz_web/NewHomePage/Cubits/ShowHideSignupPassword/show_hide_signup_password_cubit.dart';
import 'package:journz_web/NewHomePage/Cubits/ShowHideSignupReEnterPasswordCubit/show_hide_signup_reenter_password_cubit.dart';
import 'package:journz_web/NewHomePage/Helper/fav_articles_sharedpref.dart';
import 'package:journz_web/NewHomePage/Helper/search_suggestion.dart';
import 'package:journz_web/NewHomePage/Helper/signup_data_model.dart';
import 'package:journz_web/NewHomePage/Helper/signup_database.dart';
import 'package:journz_web/utils/routes.dart';
import 'package:pin_code_text_field/pin_code_text_field.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:velocity_x/velocity_x.dart';

class MobileHomePageHeader extends StatefulWidget {
  final bool? wantSearchBar;
  const MobileHomePageHeader({Key? key, this.wantSearchBar}) : super(key: key);

  @override
  _HomePageHeaderState createState() => _HomePageHeaderState();
}

class _HomePageHeaderState extends State<MobileHomePageHeader> {
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Padding(
              ...
              padding: EdgeInsets.only(right:context.screenWidth * 0.012 ),
              child: Icon(
                Icons.menu,
                color: Colors.white,
                size: 30,
